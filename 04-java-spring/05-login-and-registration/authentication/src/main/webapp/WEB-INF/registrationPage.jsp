...
<html>
    <head>
        <meta charset="UTF-8">
        <meta name="Controllers and Views project Registration Page" content="Spring Boot project named Controllers and Views">
        <meta http-equiv="X-UA-Compatible" content="ie=edge">
        <title>Controllers and Views project Registration Page</title>
